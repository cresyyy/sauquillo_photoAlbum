...
<body>
    ...
    <?php foreach ($albums as $album): ?>
        <div class="albumPost">
            <p>
                <h2 href="profile.php?userID=<?php echo $album['user_id']; ?>" style="color: #0b1957">
                    <?php echo htmlspecialchars($album['username']); ?>
                </h2>
                <span><?php echo htmlspecialchars($album['DateCreated']); ?></span>
            </p>
            <h3 style="color:#5784e6;"><?php echo htmlspecialchars($album['AlbumName']); ?></h3>
            ...
            <?php if ($photoCount > 3): ?>
                <div class="see-more">
                    <a href="viewAlbum.php?albumID=<?php echo $album['AlbumID']; ?>" style="color:#0b1957;">See more</a>
                </div>
            <?php endif; ?>
